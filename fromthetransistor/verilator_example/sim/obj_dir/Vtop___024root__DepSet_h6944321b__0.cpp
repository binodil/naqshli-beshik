...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelfRef.rst_n) {
        if ((0U == (IData)(vlSelfRef.top__DOT__state))) {
            __Vdly__top__DOT__state = 1U;
                    ...
                    & (IData)(vlSelfRef.top__DOT__dut_carryout))) {
            __Vdly__top__DOT__state = 2U;
        } else if (VL_UNLIKELY(((2U == (IData)(vlSelfRef.top__DOT__state))))) {
            VL_FINISH_MT("top.sv", 40, "");
        }
    } else {
    ...
    if (vlSelfRef.rst_n) {
        if ((1U == (IData)(vlSelfRef.top__DOT__state))) {
            vlSelfRef.top__DOT__dut_count = (0xfU & 
                                             ((IData)(1U) 
                                              + (IData)(vlSelfRef.top__DOT__dut_count)));
        }
    } else {
        vlSelfRef.top__DOT__dut_count = 0U;
    }
    vlSelfRef.top__DOT__state = __Vdly__top__DOT__state;
    vlSelfRef.top__DOT__dut_carryout = ((1U == (IData)(vlSelfRef.top__DOT__state)) 
                                        & (0xfU == (IData)(vlSelfRef.top__DOT__dut_count)));
}
